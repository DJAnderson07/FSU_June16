...
```
##  [1] "Tails" "Tails" "Heads" "Tails" "Tails" "Heads" "Tails" "Heads"
##  [9] "Heads" "Heads"
```
...
```
## Error in f[i] <- rnorm(1, mean = 0, sd = i): object of type 'closure' is not subsettable
```
...
![plot of chunk r2WinstepsPlotting](assets/fig/r2WinstepsPlotting-1.png)
